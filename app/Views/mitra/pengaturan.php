            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="card mb-4">
                        ...
                        <form method="POST" action="/mitra/ubahfotoprofil/<?= $id; ?>" enctype="multipart/form-data">
                            <div class="card-body text-center">
                                <img class="img-fluid img-preview mb-4" style="width: 250px;height: 250px;border-radius:100%" src="/assets/img/profil/mitra/<?= $akun['gambar'] ?>">
