            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="card mb-4">
                        ...
                        <form method="POST" action="/user/ubahfotoprofil/<?= $id; ?>" enctype="multipart/form-data">
                            <div class="card-body text-center">
                                <img class="img-fluid img-preview mb-4" style="width: 250px;height: 250px;border-radius:100%" src="/assets/img/profil/peserta/<?= $user['gambar'] ?>">
                ...
                <div class="col-lg-8">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form method="POST" action="/user/ubahsandi/<?$id?>">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="card card-body" method="POST" action="/user/ubahprofil/<?= $id ?>">
                        <div class="form-group">
